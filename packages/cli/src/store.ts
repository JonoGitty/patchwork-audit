...
export { EVENTS_PATH, DB_PATH, DATA_DIR, SEAL_KEY_PATH, KEYRING_DIR, SEALS_PATH, DIVERGENCE_MARKER_PATH, SYNC_REPORT_PATH, PRETOOL_TELEMETRY_PATH, WITNESSES_PATH, ATTESTATIONS_DIR, ATTESTATION_PATH };

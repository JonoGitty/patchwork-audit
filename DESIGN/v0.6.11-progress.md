...
| 9 | `feat(cli+agents): approve + clear-taint + trust-repo-config` | _pending_ | +12 |

**Tests: 943 → 1429 (+486 since v0.6.10).** Build clean across all packages.
...
## What's left (3 commits + 1 GPT-5.5 review gate)

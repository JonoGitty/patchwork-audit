...
## What's left (6 commits)

| # | Commit | Why supervised vs autonomous |
|---|---|---|
...
| 11 | `test(integration): release-gate scenarios A1-A8 + must all pass in enforce mode` | The merge bar. Needs 7+8 wired first. |
| 12 | `chore(release): v0.6.11` | Tag + npm publish + GitHub release. Needs Jono. |
